...
def lift_down():
    ...
    pca_output.channels[4].duty_cycle = int(0 / 100 * 0xFFFF)
    pca_output.channels[5].duty_cycle = int(100 / 100 * 0xFFFF)
...
def level_down():
    ...
    pca_output.channels[6].duty_cycle = int(100 / 100 * 0xFFFF)
...
def level_up():
    ...
    pca_output.channels[6].duty_cycle = int(0 / 100 * 0xFFFF)
    pca_output.channels[7].duty_cycle = int(100 / 100 * 0xFFFF)
